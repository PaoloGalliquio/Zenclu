        ...
        <div className="text-center modalBackground fadeIn fast">
            <div className="row modalContainer">
                <div className="container-icon">
                    <img src={CloseIcon} height="25" className="close-icon" onClick={() => {
                ...
                <div className="container-icon">
                    ...
                    <Button variant="light" className="text-center mb-3 modalWidth bg-white">Continúa con Facebook</Button>
                </div>
                <div className="container-icon">
                    <img src={GoogleIcon} height="25" className="login-icon"/>
                    <Button variant="light" className="text-center mb-3 modalWidth bg-white">Continúa con Google</Button>
                </div>
                <p>o continúa con</p>
                ...
                <small className="mb-3">Al hacer click en Crear cuenta, indicas que leíste y reconoces los <b className="modalLink">Términos y condiciones</b> de Zenclu.</small>
                <div className="text-center mb-3">
                    <Button variant="primary" className="text-center w-50 modalButton" onClick={() => {
                        props.register(false)
                        props.info1(true)
                    }}>Crear cuenta</Button>
                </div>
                <p>¿Ya tienes cuenta? 
                    <b className="modalLink" onClick={() => {
                        props.register(false)
                        props.login(true)}
                    }> Inicia sesión</b>
                </p>
