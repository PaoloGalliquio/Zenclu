        ...
        <div className="text-center modalBackground fadeIn fast">
            <div className="row modalContainerInfo">
                <div className="container-icon mb-2">
                    <img src={CloseIcon} height="25" className="close-icon-info" onClick={() => {
                ...
                <div className="row">
                    ...
                    <div className="col-md-8 pt-2 container-icon">
                        ...
                        <Form.Control type="text" placeholder="" className="mb-3 modalWidth w-100 bg-white" readOnly/>
                    </div>
                    <div className="col-md-2 my-auto">
                        <Button variant="primary" className="text-center w-100 modalButton">Agregar</Button>
                    </div>
                </div>
                <div className="row">
                    <div className="col-md-2 my-auto">
                    ...
                    <div className="col-md-10 pt-2 container-icon">
                        <div className="tag-icon1">Moda <b>x</b></div>
                        <div className="tag-icon2">Tecnología <b>x</b></div>
                        <div className="tag-icon3">Ciencia <b>x</b></div>
                        <Form.Control type="text" placeholder="" className="mb-3 modalWidth w-100 bg-white" readOnly/>
                    </div>
                </div>
                <div className="row text-center mt-3">
                    <div className="col-md-12">
                        <Button variant="success" className="text-center w-50 modalButton modalNextButton" onClick={() => {
                            document.getElementById('app-root').style.filter = 'blur(0px)'
                            props.info(false)
                        }}>Confirmar</Button>
                    </div>
